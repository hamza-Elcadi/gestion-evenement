                    ...
                    @if (isset($_GET['addModulator']) || isset($_GET['updatedUser_id']))
                        @if (isset($_GET['addModulator']))
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div>
                                    <a href="{{ route('modulator') }}"><button type="button"
                                            class="btn btn-secondary">Modulator list</button></a>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                @elseif(isset($_GET['updatedUser_id']))
                                    ...
                                    <div class="card-body">
                                        <form method="post"
                                            action="{{ route('updateModulator', ['updatedUser_id' => $_GET['updatedUser_id']]) }}">
                        @endif
                        @csrf
                        <div class="row">
                            <div class="col-md-5 pr-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Username" name="name_user"
                                        value="{{ isset($modulator1) ? $modulator1->name_user : '' }}">
                                </div>
                            </div>
                            <div class="col-md-3 px-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="CIN" name="cin"
                                        value="{{ isset($modulator1) ? $modulator1->cin : '' }}">
                                </div>
                            </div>
                            <div class="col-md-4 pl-1">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" placeholder="Email" name="email_user"
                                        value="{{ isset($modulator1) ? $modulator1->email_user : '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 pr-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Password" name="pw_user"
                                        value="{{ isset($modulator1) ? $modulator1->pw_user : '' }}">
                                </div>
                            </div>
                            <div class="col-md-6 pl-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Tel" name="tel_user"
                                        value="{{ isset($modulator1) ? $modulator1->tel_user : '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <select class="custom-select" id="inputGroupSelect01" name="id_role">
                                        @if ($roles->count() > 0)
                                            @foreach ($roles as $role)
                                                <option value="{{ $role->id_role }}" selected>{{ $role->name_role }}
                                                </option>
                                            @endforeach
                                        @else
                                    ...
                                    @foreach ($modulators as $modulator)
                                        <tr>
                                            ...
                                            <td scope="row" class="d-flex justify-content-between">
                                                <a
                                                    href="{{ route('deleteUser', ['deletedUser_id' => $modulator->id_user]) }}"><i
                                                        class="fa-solid fa-trash"></i></a>
                                                <a
                                                    href="{{ route('modulator', ['updatedUser_id' => $modulator->id_user]) }}"><i
